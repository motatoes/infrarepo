...
module "monitoring-node0789c" {
  ...
  module "service-node0789c" {
    ...
    container_port = "8080"
    # replicas
    container_name = "nodeae550-nodeed82e-node0789c"
    launch_type = "FARGATE"
  ...
  output "node0789c_docker_registry" {
    value = module.service-node0789c.docker_registry
  }

  output "node0789c_lb_dns" {
    value = module.service-node0789c.lb_dns
  }

  output "node0789c_lb_arn" {
    value = module.service-node0789c.lb_arn
  }

  output "node0789c_lb_http_listener_arn" {
    value = module.service-node0789c.lb_http_listener_arn
  }
